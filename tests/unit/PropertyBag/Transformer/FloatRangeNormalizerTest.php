...
class FloatRangeNormalizerTest extends \Codeception\Test\Unit
{
    ...
    public function testNormalizer()
    {
        ...
        $this->assertSame(1.0, $normalizer->normalize(0.0));
        $this->assertSame(1.0, $normalizer->normalize(-30.0));
        
        $normalizer = FloatRangeNormalizer::make(null, 40.5);
        $this->assertSame(0.0, $normalizer->normalize(0.0));
        $this->assertSame(40.5, $normalizer->normalize(40.5));
        $this->assertSame(40.5, $normalizer->normalize(41.0));
        
        $normalizer = FloatRangeNormalizer::make(2, 40);
        $this->assertSame(2.0, $normalizer->normalize(0.0));
        $this->assertSame(10.0, $normalizer->normalize(10.0));
        $this->assertSame(40.0, $normalizer->normalize(41.0));
    }
